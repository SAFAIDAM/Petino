                    ...
                    <div className={showComments[index] ? "absolute bg-[#ffffff] rounded-t-[25px] top-0 w-full h-[80%] overflow-x-hidden": "hidden" }>
                        ...
                        <div className="flex justify-between items-center custom-shadow bg-[#f1f1f1] p-2 sticky z-auto top-[88%] mt-6">
                            <div className="flex justify-between items-center gap-1">
                                <img className="w-[30px] h-[30px] rounded-full" src={currentUser.currentUser.profilePicture} alt="user picture" />
                                ...
                                <div key={comment._id}>
                                    <div className="flex items-center justify-between ml-2 mb-4">
                                        <div className="flex items-center gap-2">
                                            <img className="w-[35px] self-start h-[35px] rounded-full border" src={currentUser.currentUser.profilePicture} alt="user picture" />
                                            <div className="">
                                                <p className="text-[14px] font-bold">{currentUser.currentUser.username}</p> 
