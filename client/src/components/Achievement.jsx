...
const Achievement = () => {
  return (
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 mt-7 gap-4">
        <div className="flex flex-col items-center md:items-left lg:items-center xl:items-center 2xl:items-center mx-3">
          <img
            src={achievementone}
            alt="Charlie"
            className="w-full md:w-auto lg:w-auto rounded-lg"
          />
