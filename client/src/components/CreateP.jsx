...
const CreateP = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log(uploadedImageUrl, 'tetetetet');
    ...
    return (
        <>
            ...
            {/* Create Space */}
            <form onSubmit={handleSubmit} className="flex flex-col w-[300px] sm:w-[80%] md:w-[680px] custom-shadow bg-white mx-auto mt-6 mb-[80px] py-3 md:py-6 px-4 md:p-8 rounded-[20px]">
                <div>
                ...
                <div>
                    ...
                    <div className="flex items-center justify-between mt-5">
                        <div className="flex items-center gap-2">
                            <div>
                                <label htmlFor="image" className="bg-[#E06C2E] text-[15px] md:text-[17px] text-white flex items-center gap-1 md:gap-2 py-2 px-2 md:px-3 rounded-[30px]">
                                    <HiOutlineUpload />
                                    Upload Image
                                </label>
                        ...
                        <button type="submit" className="text-white text-[15px] bg-[#8FA1F7] py-2 px-3 rounded-[30px]">Add Post</button>
                    </div>
                </div>
                <div>
                    {/* Display the message */}
                ...
                <div className="flex items-center justify-center w-full mb-3">
                    {selectedImageUrl && <img src={selectedImageUrl} alt="Selected" className="object-cover md:w-[50%] md:h-[140px] rounded h-[100px]" />}
                </div>
            </form>
            <Footer />
        </>
