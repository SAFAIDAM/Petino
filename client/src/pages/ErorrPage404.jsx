...
function ErorrPage404() {
  return (
    ...
    <div className='flex flex-col items-center justify-center mt-22'>
      ...
      <Link to='/'>
      <div className=' border border-[#EA7F48] pl-12 pr-12 p-2 rounded-full text-white text-center transition duration-300 ease-in-out delay-150 bg-[#EA7F48] hover:-translate-y-1 hover:scale-110 hover:bg-[#EA7F48]'><button className=''>Back</button></div>
      </Link>
